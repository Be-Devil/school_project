...
void Bh1750_Test(void)
{
	   ...
	   u16 light =0;
	   u8 light_string[] ={"light is :     lx\n"};
//     u8 light_data[5];
     u8 i;

     light = Dispose();
	
// 	   DataD_To_Ascii( light ,5 , light_data );
//      Replace_To_String( light_string ,light_data, 10,5 );
      for(i=0;i<5;i++)
      {
           light_string[14-i] = light%10 +0x30;
				   light /=10;
      }
     

     U1Send_String( light_string );
